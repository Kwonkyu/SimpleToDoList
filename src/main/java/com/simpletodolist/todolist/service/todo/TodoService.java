...
public interface TodoService {
     ...
     * @param todoId To-do's id.
     * @return TodoDTO.Response object filled with to-do.
     * @throws NoTodoFoundException when to-do doesn't exist.
     */
    Response readTodo(long todoId) throws NoTodoFoundException;

    /**
     * Read to-dos from to-do list.
     * @param todoListId To-do list's id.
     * @return TodosDTO.Response object filled with to-dos.
     * @throws NoTodoListFoundException when to-do list with given id does not exist.
     */
    List<Response> readTodosOfTodoList(long todoListId) throws NoTodoListFoundException;

    /**
     * Write to-do on to-do list.
     * @param todoListId To-do list's id.
     * @param todoDTO TodoDTO.RegisterRequest object filled with to-do data.
     * @return TodoDTO.Response object filled with to-do data and generated id.
     */
    Response createTodo(String memberUserId, long todoListId, Create todoDTO) throws NoMemberFoundException, NoTodoListFoundException;
     ...
     * @return TodoDTO.Response object filled with updated to-do.
     * @throws NoTodoFoundException when to-do with given id doesn't exists.
     */
    Response updateTodo(long todoId, Update.UpdatableTodoInformation field, Object value) throws NoTodoFoundException;

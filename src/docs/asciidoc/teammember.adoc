...
:method-joinmember: POST
:url-joinmember: /api/team/<teamId>/members
:method-quitmember: DELETE
:url-quitmember: /api/team/<teamId>/members/<memberId>
:method-changeleader: PUT
:url-changeleader: /api/team/<teamId>/leader/<memberId>
...
.요청 파라미터
include::{snippets}/TeamMembersController/joinMember/request-fields.adoc[]

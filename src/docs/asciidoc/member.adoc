...
== Request Joined Teams
현재 사용자가 가입된 팀을 조회하는 API입니다.
...
== Join Team
팀에 가입하기 위한 API입니다. 팀이 제한 상태(locked)일 경우 가입할 수 없습니다.
...
== Quit Team
팀에서 탈퇴하기 위한 API입니다. 가입과 달리 특별한 제한이 없습니다.
